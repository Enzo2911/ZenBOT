...
module.exports = {
    ...
    description: "Permet de générer un compte delarte si vous est Platinium ou Ultimate",
                ...
                db.query(`SELECT id, user, pass, capture FROM gendelarte`, async (error, results2) => {
                    ...
                    if (results2[0] !== undefined) {
                        if (results[0].plat === 1) {
                            ...
                            message.author.send(`Voici le Compte delarte : ${results2[0].user}:${results2[0].pass} // Capture :  ${results[0].capture}`)
                        ...
                        message.reply("Désolé il n'y a plus de compte delarte");
                    }
                })
            } else {
