...
module.exports = {
    ...
    description: "Permet de générer un Compte King365 si vous est Platinium ou Ultimate ou AutoHit",
                ...
                db.query(`SELECT id, user, pass, capture FROM genking365`, async (error, results2) => {
                    ...
                    if (results2[0] !== undefined) {
                        if (results[0].plat === 1) {
                            ...
                            message.author.send(`Voici le Compte King365 : ${results2[0].user}:${results2[0].pass} // Capture :  ${results[0].capture}`)
