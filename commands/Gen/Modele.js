...
module.exports = {
    /* aliases: ["gen-diminutif"], */
    /* name: "gen-nom", */
    category: "GenerateurCompte",
    description: "Permet de généré un Compte nom si vous êtes Platinium ou Ultimate ou AutoHit",
                    ...
                    db.query(`SELECT id, user, pass, capture as cap FROM genmolov`, async (error, results2) => {
                        ...
                        if (results2[0] !== undefined) {
                            if (results[0].plat === 1) {
                                ...
                                message.author.send(`Voici le Compte nom : ${results2[0].user}:${results2[0].pass} // Capture :  ${results2[0].cap}`).catch(() => message.reply("Active tes DM plz"));
                                console.log("")
                            ...
                            message.reply("Désolé il n'y a plus de Compte nom");
                        }
                    })
                } else {
